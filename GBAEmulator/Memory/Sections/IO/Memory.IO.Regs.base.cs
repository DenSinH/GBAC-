...
namespace GBAEmulator.Memory.IO
{
    ...
    class DefaultRegister : IORegister2 { }  // basically default register (name might be a bit misleading)

    class ZeroRegister : IORegister
    {
        public ushort Get()
        {
            return 0;
    ...
    class UnusedRegister : IORegister4<UnusedRegisterHalf>
    {
