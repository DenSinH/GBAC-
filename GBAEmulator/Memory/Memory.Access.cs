    ...
    partial class MEM
    {
        ...
        private int GetWordAccessCycles(uint section, uint address)
        {
            ...
            else if (section < 16)
            {
                ...
                {
                    // S access
                    cycles = 1 + this.IO.WAITCNT.SCycles[section - 8];
                }
                else
                {
                    // N access
                    cycles = 1 + this.IO.WAITCNT.NCycles[section - 8];
                }
                // GBATek:
                ...
                cycles += this.IO.WAITCNT.SCycles[section - 8];
            }
        ...
        private int GetNonWordAccessCycles(uint section, uint address)
        {
            ...
            else if (section < 16)
            {
                ...
                {
                    // N access
                    cycles = this.IO.WAITCNT.NCycles[section - 8];
                }
            }
            // else: out of bounds! (how many cycles?)
