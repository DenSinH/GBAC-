    ...
    partial class PPU
    {
        ...
        private void ResetOBJWindow()
        {
            ...
            this.ResetWindow<bool>(ref OBJWindow,
                this.gba.mem.IORAMSection.WININ.WindowOBJEnable(Window.Window0), this.gba.mem.IORAMSection.WININ.WindowOBJEnable(Window.Window1),
                this.gba.mem.IORAMSection.WINOUT.WindowOBJEnable(Window.OBJ), this.gba.mem.IORAMSection.WINOUT.WindowOBJEnable(Window.Outside), true);
        }
        ...
        private void RenderOBJs(bool UseOBJWindowMask = false)  // assumes y = scanline
        {
            ...
            this.OAM2DMap = this.gba.mem.IORAMSection.DISPCNT.IsSet(DISPCNTFlags.OBJVRAMMapping);
            ...
            ushort OBJ_ATTR1, ushort OBJ_ATTR2, bool EnableBlending, bool UseOBJWindowMask = false)
        {
            ...
            if (Mosaic)
                dy -= (byte)(dy % this.gba.mem.IORAMSection.MOSAIC.OBJMosaicVSize);
                ...
                for (int dTileX = 0; dTileX < (OBJsz.Width >> 3); dTileX++)
                {
                    ...
                    if (UseOBJWindowMask)
                    {
                        this.Render4bpp(
                            ...
                            Mosaic,
                            this.gba.mem.IORAMSection.MOSAIC.OBJMosaicHSize);
                    }
                    else
                    {
                        this.Render4bpp(
